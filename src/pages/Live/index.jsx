  ...
  const getAllRoom = async () => {
    try {
      const res = await axios.get(
        `${api.test_url}/api/v1/room/get-all-live-stream`,
      )
                    ...
                    <>
                      <div className='live-video'>
                        <VideoPlayer
                          source={GameVideo}
                          width={'100%'}
                          coverpicture={livegamecover}
                        />
                      </div>
                      <div className='video-icons'>
                        <span
                          className='video-icons-one'
                          style={{ color: 'white' }}
                        >
                          {' '}
                          <BsFillPlayFill />
                ...
                <div className='mt-2'>
                  <div className='form-group'>
                    <input
                      type='text'
                      onChange={e =>
                        setState({ ...state, room_name: e.target.value })
                      }
                  ...
                  >
                    <input type='radio' value='public' name='privacy' checked />{' '}
                    Public <span>{}</span>
                    <input type='radio' value='private' name='privacy' />{' '}
                    Private
                  </div>
