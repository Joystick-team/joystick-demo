...
import JOYSTICK from "/assets/images/newLogo.png";
...
export default function DevErrorPage() {
  ...
  const [themeDetector, setThemeDetector] = useState(
    localStorage.getItem("dark") ?? deviceTheme
  );
      ...
      <div className="dev__error_content__container">
        <div className="dev__error_content">
          ...
          <div className="dev__error_content__title">
            <h3>
              {" "}
              <span>Oooops!</span> Wrong Move
            </h3>
          </div>
          <div className="dev__error_content__message">
            <p>
              You’ve found a page that does’t exist. Breathe in, breath out, eat
              well and try again
            </p>
          </div>
