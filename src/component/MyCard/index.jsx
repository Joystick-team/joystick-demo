...
export default function MyCard(props) {
  return (
    <div className='mycard'>
        <Card className={`${props.cardClass ?? 'mb-3 mycard-card' }`} style={{ border: 'none', color: 'var(--primary--text)', background: 'var(--background)'}}>
            ...
            <Card.Body className="mycard-body" style={{/*padding: '1rem 0px 0rem'*/}}>
                ...
                <Button className="mycard-btn" style={{ padding: '0rem'}} variant='var(--primary--text)' onClick={props.openModal}> {props.button} </Button>
                {/* <button className="mycard-btn" style={{color: 'var(--primary--text)', padding: '0rem'}} onClick={props.clickDetails}> {props.button} </button> */}
            </Card.Body>
